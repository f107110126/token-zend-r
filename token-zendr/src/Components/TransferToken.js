    ...
    return (
        <div className='panel-block is-paddingless is-12'>
            <div className='column is-12' id='token-lists'>
                ...
                <InputField onInputChangeUpdateField={props.onInputChangeUpdateField}
                    fields={props.fields} name='amount' placeholder='Amount to Transfer'
                    addon={props.transferDetail.symbol.toUpperCase()} />

                <InputField onInputChangeUpdateField={props.onInputChangeUpdateField}
                    default={props.defaultGasPrice} fields={props.fields} name='gasPrice'
                    placeholder='Gas Price In Gwei' addon='Gas Price(gwei)' />

                <InputField onInputChangeUpdateField={props.onInputChangeUpdateField}
                    default={props.defaultGasLimit} fields={props.fields} name='gasLimit'
                    placeholder='Gas Limit' addon='Gas Limit' />
